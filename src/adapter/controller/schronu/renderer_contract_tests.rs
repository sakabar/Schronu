...
fn calendar_displayはtyped日別値を逆順と週区切りとsummaryとalertへ描画する() {
    ...
    assert_eq!(
        ...
        [
            ...
            "newline:",
            "newline:[Crit] 【今日までの】〆切に間に合わないタスクが3件あります。最初の対象日: 2026-08-23, 最大超過: 0時間15分。【ただちに】`全 〆`で対象を確認し、予定を前倒しするか〆切を調整してください。",
            "newline:[Crit] 【今日の】終了予定時刻を0時間08分超過します。【ただちに】`尾`で候補を確認し、予定を減らすか明日以降へ延期してください。",
            "newline:[Warn] 【明日の】〆切に間に合わないタスクが1件あります。対象日: 2026-08-24, 最大超過: 0時間15分。【今日中に】`全 〆`で対象を確認し、予定を前倒しするか〆切を調整してください。",
            "newline:[Warn] 【明日の】終了予定時刻を1時間44分超過します。【今日中に】`尾 明`で候補を確認し、予定を減らすかあさって以降へ延期してください。",
            "newline:[Warn] 【7日以内の】〆切に間に合わないタスクが2件あります。最初の対象日: 2026-08-25, 最大超過: 3時間54分。【近々】`全 〆`で対象を確認し、予定を前倒しするか〆切を調整してください。",
