...
fn copy_for_spreadsheetは新しい業務日の最初のp列へ睡眠420分を算入する() {
    ...
    assert_eq!(
        ...
        [
            ...
            ("0005", "=IF(OR(R8=\"W\", R8=\"d\"), L8, L8+TIME(0, G8, 0))",),
            (
                "0006",
            ...
            (
                "0007",
                "=IF(OR(R10=\"W\", R10=\"d\"), L10, L10+TIME(0, G10+420, 0))",
            ),
            (
                "0008",
                "=IF(OR(R11=\"W\", R11=\"d\"), L11, L11+TIME(0, G11, 0))",
            ),
            (
                "0009",
                "=IF(OR(R12=\"W\", R12=\"d\"), L12, L12+TIME(0, G12+420, 0))",
            ),
        ]
    );
}
